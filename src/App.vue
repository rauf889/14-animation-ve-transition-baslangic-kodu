    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        ...
        <transition :name="activeEffect" appear>
          <div class="alert alert-success" v-show="!show">This is an alert box..</div>
        </transition>
        <hr>
        <transition name="slide" type="animation" appear>
          <div class="alert alert-warning" v-show="!show">This is a warning box..</div>
        </transition>
        <hr>
        <transition
          enter -class=""
          enter-active-class="animate__animated animate__shake"
          leave-class=""
        ...
        <transition name="fade" mode="out-in">
          <div class="alert alert-success" v-if="show" key="success">This is an alert box..</div>
          <div class="alert alert-danger" v-else key="danger">This is a box..</div>
        </transition>
        <hr>
        <button class="btn btn-primary" @click="showJS =!showJS">Show/Hide box</button>
        <br><br>
        <transition
        :css="false"
        ...
        width: 100px;
        height: 100px;"
          v-if="!showJS">This is an alert box..</div>
        </transition>
        <hr>
        <h3>Dinamik Componentler Arasinda Gescis...</h3> 
